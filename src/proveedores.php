    ...
    if (empty($_POST['nombre']) || empty($_POST['apellido']) ||  empty($_POST['telefono']) || empty($_POST['direccion']) || empty($_POST['descripcion'])) {
        ...
        if (empty($id)) {
            ...
            if ($result > 0) {
                ...
                $query_insert = mysqli_query($conexion, "INSERT INTO proveedores(nombre,apellido,telefono,direccion,descripcion) values ('$nombre', '$apellido', '$telefono', '$direccion', '$descripcion')");
                if ($query_insert) {
            ...
            $sql_update = mysqli_query($conexion, "UPDATE proveedores SET nombre = '$nombre' , apellido = '$apellido' , telefono = '$telefono', direccion = '$direccion', descripcion = '$descripcion' WHERE idproveedor = $id");
            if ($sql_update) {
                $alert = '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Ingrese Descripción" name="descripcion" id="descripcion" class="form-control" rows="3"></textarea>
                            </div>
                        </div>
